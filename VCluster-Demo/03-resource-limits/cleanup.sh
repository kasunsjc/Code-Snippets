#!/bin/bash
# =============================================================================
# Demo 03 — Cleanup: Remove limits vcluster and all associated host resources
# =============================================================================
...
VCLUSTER_NAME="limits"
VCLUSTER_NS="vc-limits"
...
echo ""
echo -e "${CYAN}================================================${NC}"
echo -e "${CYAN}  Demo 03 — Cleanup                             ${NC}"
echo -e "${CYAN}================================================${NC}"
...
# --delete-namespace: also removes the host namespace (including the ResourceQuota
# and LimitRange objects that were applied to it in Step 1 of the demo).
...
# Belt-and-suspenders: also removes the ResourceQuota and LimitRange that were
# applied to the namespace during the demo setup.
kubectl delete namespace "$VCLUSTER_NS" --ignore-not-found=true
ok "Namespace '$VCLUSTER_NS' (and its ResourceQuota/LimitRange) deleted"
...
echo ""
echo -e "${GREEN}Demo 03 cleanup complete.${NC}"
echo ""
