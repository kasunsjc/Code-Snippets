# Scenario 04 — Prometheus Scaler (Azure Managed Prometheus)
...
kubectl apply -f scenarios/04-prometheus/00-trigger-auth.yaml

# 3. Update 03-scaled-object.yaml with the Prometheus endpoint, then deploy
kubectl apply -f scenarios/04-prometheus/01-sample-app.yaml
kubectl apply -f scenarios/04-prometheus/02-service.yaml
kubectl apply -f scenarios/04-prometheus/03-scaled-object.yaml
...
kubectl apply -f scenarios/04-prometheus/04-load-generator-job.yaml
