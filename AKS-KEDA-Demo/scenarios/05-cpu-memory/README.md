...
kubectl apply -f scenarios/05-cpu-memory/ -n keda-demo
...
kubectl apply -f scenarios/05-cpu-memory/03-cpu-stress-job.yaml -n keda-demo
...
# 7. Cleanup
kubectl delete -f scenarios/05-cpu-memory/ -n keda-demo
```
